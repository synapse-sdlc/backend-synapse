...
class Artifact(Base):
    ...
    parent_id: Mapped[Optional[str]] = mapped_column(String(12), ForeignKey("artifacts.id"), nullable=True)
    ...
    previous_version_id: Mapped[Optional[str]] = mapped_column(String(12), ForeignKey("artifacts.id"), nullable=True)
